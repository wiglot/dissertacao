...
Para demonstrar a predição, é apresentado um gráfico de cargas na Figura \ref{fig:grafico_predicao}.
...
Os dados utilizados nesse gráfico estão disponíveis na Anexo A.
...
\caption{Gráfico de cargas e estimativas em caso de defeitos\label{fig:grafico_predicao}}
