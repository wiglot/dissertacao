...
\begin{minipage}{8cm}
\begin{espacosimples}
Exame de qualificação apresentada ao Programa de Pós-graduação \textit{Strictu Sensu} em
...
\vspace {1cm}
\begin{center}
Exame de qualificação defendido e aprovada em: 6 de Janeiro de 2012.\\
Banca examinadora:
\end{center}
\vfill
